...
import metrics_precision_recall as sm

# //////////////////////////////////////// Load model
model_name = "1650904979"
...
# generating an Instance of the MetricsPreRe class and dropping in the predictions and ground truth
x = sm.MetricsPrecisionRecall(predictions, test_labels)
# calling the plot method to visualize Prediction and Recall for class 42
x.plot(1)
# Get a Log of all classes in the Test Batch
x.log()
...
# There is more and this should get you started: https://www.tensorflow.org/api_docs/python/tf/keras/metrics However
# it is not about how many metrics you crank out, it is about whether you find the meangingful ones and report on
# them. Think about a system on how to decide which metric to go for..
